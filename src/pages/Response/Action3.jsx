...
const ECG_DATA = Array.from({ length: 200 }, (_, i) => {
    ...
    const t_wave = i % 40 >= 16 && i % 40 <= 22 ? Math.sin(((i % 40 - 16) / 6) * Math.PI) * 7 : 0;
    ...
    return (
        <Box sx={{ width: "100%", display: "block" }}>
            <svg width="100%" viewBox={`0 0 ${width} ${height}`} style={{ display: "block" }}>
                <defs>
                    <pattern id={`grid-v-${id}`} width="82.5" height={height} patternUnits="userSpaceOnUse">
                        <line x1="82.5" y1="0" x2="82.5" y2={height} stroke="#1e3a5f" strokeWidth="0.5" />
                    </pattern>
                    <pattern id={`grid-h-${id}`} width={width} height="20" patternUnits="userSpaceOnUse">
                        <line x1="0" y1="20" x2={width} y2="20" stroke="#1e3a5f" strokeWidth="0.5" />
                    </pattern>
                </defs>
                ...
                {[0, 1, 2, 3, 4, 5, 6, 7, 8].map((s) => (
                    <text key={s} x={(s / 8) * width + 2} y={height - 3} fill="#4a7fa5" fontSize="8">
                        {s}s
                    </text>
                ))}
            </svg>
    ...
    <CloseIcon />
            ...
            >
                ...
                <Box sx={{ flex: 1, p: "20px 24px", minWidth: 0 }}>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 1, mb: 2 }}>
                        ...
                        >
                            ...
                            <Typography sx={{ color: "#475569", fontSize: "11px", whiteSpace: "nowrap" }}>
                    ...
                    <Box sx={{ mb: 2 }}>
                        ...
                        >
                            <Typography sx={{ fontSize: 15, fontWeight: 700, color: "#D2D6DB" }}>
                                12-Lead Overview
                            </Typography>
                            <Box sx={{ display: "flex", gap: 1.5, fontSize: 11, color: "#64748b", flexWrap: "wrap" }}>
                                <Typography component="span" sx={{ fontSize: 11 }}>Auto-gain</Typography>
                                <Typography component="span">·</Typography>
                                <Typography component="span" sx={{ fontSize: 11 }}>25mm/s</Typography>
                                <Typography component="span">·</Typography>
                                <Typography component="span" sx={{ fontSize: 11 }}>10mm/mV</Typography>
                                <Typography component="span">·</Typography>
                                <Typography component="span" sx={{ fontSize: 11, }}>OK</Typography>
                                <Typography component="span">·</Typography>
                                <Typography component="span" sx={{ fontSize: 11 }}>Artifact</Typography>
                            </Box>
                        </Box>
                ...
                >
                                ...
                                return (
                                    ...
                                    >
                                        <Box sx={{ display: "flex", gap: 1, width: "120px" }}>
                                            <Typography sx={{ fontSize: "14px", fontWeight: 300, color: "#D2D6DB" }}>
                                                {left.label}
                                            </Typography>
                                            <Typography sx={{ fontSize: "14px", fontWeight: 700, color: "#D2D6DB" }}>
                                                {left.value}
                                            </Typography>
                                        </Box>
                                        <Box sx={{ display: "flex", gap: 1, width: "120px" }}>
                    ...
                    >
                        {/* AI Assist Header with Gemini Gradient */}
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            <AIAssistIcon />
