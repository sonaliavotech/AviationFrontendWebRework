...
const Sidebar = ({ onAiClick }) => {
  ...
  const mainItems = [
    ...
    { label: "FAQs", Icon: AppAssets.FAQsIcon, path: "/faqs", hoverable: true },
    {
      label: "Alerts",
        ...
        >
          ...
          >
            ...
            <path
              ...
              stroke={!darkMode ? tokens.sidebarActive : tokens.sidebarInactive}
              strokeWidth="2"
              strokeLinecap="round"
            />
          </svg>
          ...
          <Switch
            ...
            sx={{
              "& .MuiSwitch-switchBase.Mui-checked": { color: tokens.sidebarActive },
              "& .MuiSwitch-switchBase.Mui-checked + .MuiSwitch-track": {
                backgroundColor: tokens.sidebarActive,
              },
              "& .MuiSwitch-track": { backgroundColor: tokens.sidebarSwitchTrack },
            }}
          />
