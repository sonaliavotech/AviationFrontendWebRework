...
class AviationCallSocket {
  ...
  connect(userId) {
    ...
    this.socket.on("aviation_call_cancelled", (data) => {
      console.log("🔕 Web Call cancelled on other device:", data);
      this._emit("aviation_call_cancelled", data);
    });
  ...
  acceptCall(data) {
    ...
    console.log("📤 Emitting aviation_callAccept:", payload);
